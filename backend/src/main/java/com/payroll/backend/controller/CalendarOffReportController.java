...
public class CalendarOffReportController {

    private final CalendarOffReportService calendarOffReportService;

    @GetMapping("/calendar-off")
    public List<CalendarOffReportRow> calendarOff(
        ...
        return calendarOffReportService.calendarOff(type, from, to, branchId, departmentId, designationId, employeeId, principal);
    }
}
