...
public class EmployeeDocumentController {
    ...
    public List<EmployeeDocumentResponse> listDocuments(@PathVariable Long employeeId) {
        return employeeDocumentService.listDocuments(employeeId);
    }
    ...
    public ResponseEntity<ByteArrayResource> downloadDocument(@PathVariable Long employeeId, @PathVariable Long documentId) {
        EmployeeDocument document = employeeDocumentService.getDocument(employeeId, documentId);
        return fileResponse(document, true);
    }

    @GetMapping("/documents/{documentId}/preview")
    public ResponseEntity<ByteArrayResource> previewDocument(@PathVariable Long employeeId, @PathVariable Long documentId) {
        EmployeeDocument document = employeeDocumentService.getDocument(employeeId, documentId);
    ...
    @PreAuthorize("hasAnyRole('ADMIN','HR')")
    public MessageResponse deleteDocument(@PathVariable Long employeeId, @PathVariable Long documentId) {
    ...
    public ResponseEntity<ByteArrayResource> getProfilePhoto(@PathVariable Long employeeId) {
        EmployeeDocument document = employeeDocumentService.getProfilePhoto(employeeId);
        return fileResponse(document, false);
    }

    @DeleteMapping("/profile-photo")
    @PreAuthorize("hasAnyRole('ADMIN','HR')")
    public MessageResponse deleteProfilePhoto(@PathVariable Long employeeId) {
        employeeDocumentService.deleteProfilePhoto(employeeId);
